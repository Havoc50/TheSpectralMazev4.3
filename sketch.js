...
if (gameState!=="enter" && nani === 0){
 ...
 { 
  ...
  fill(0, 0, 0);
    ...
    textSize(18);
    text("Congratulations!", 235, 8790);
    textSize(14);
    text("You conquered the Enigma Realm!", 195, 8820);
    textSize(10);
    text("Feel free to try this game as many times as you like by refreshing the page", 150, 8965);
    textSize(12);
    text("Your score was: " + score + "!" , 240, 8995);
  ...
  if(Player.y > 6000 && Player.y < 7000){
    ...
    text("Timer: " + tt4 + ":", camera.position.x + 130, camera.position.y + 100);
      ...
      if(tt5 < 10){
        text("0", camera.position.x + 181, camera.position.y + 100);
        text(tt5, camera.position.x + 188, camera.position.y + 100);   
      }
    textStyle(NORMAL);
  }
  fill(0, 0, 0);
